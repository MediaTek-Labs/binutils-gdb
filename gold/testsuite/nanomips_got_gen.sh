...
check nanomips_got_gen.stdout "00020010  [0-9a-f]\+ R_NANOMIPS_GLOBAL 00000000   an_extra_ordinarily_lo"
check nanomips_got_gen.stdout "0002000c  [0-9a-f]\+ R_NANOMIPS_GLOBAL 00000000   strcmp"
...
check nanomips_got_gen_wide.stdout "00020010  [0-9a-f]\+ R_NANOMIPS_GLOBAL      00000000   an_extra_ordinarily_long_function_name_for_testing_readelf_output_width_control"
check nanomips_got_gen_wide.stdout "0002000c  [0-9a-f]\+ R_NANOMIPS_GLOBAL      00000000   strcmp"
